...
from fabric_cicd._common._hostname_validator import validate_and_get_env_variable
...
# API URLs
DEFAULT_API_ROOT_URL = validate_and_get_env_variable(EnvVar.DEFAULT_API_ROOT_URL.value, "https://api.powerbi.com")
FABRIC_API_ROOT_URL = validate_and_get_env_variable(
    EnvVar.FABRIC_API_ROOT_URL.value, "https://api.fabric.microsoft.com"
)
