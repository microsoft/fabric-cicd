...
class TestRefreshDeployedItemsDynamicVars:
    """Tests for _refresh_deployed_items behavior with contains_param_vars flag."""

    def test_dynamic_find_value_triggers_attribute_collection(self, temp_workspace_dir, valid_workspace_id):
...
""",
    ...
    def test_static_params_skip_attribute_collection(self, temp_workspace_dir, valid_workspace_id):
